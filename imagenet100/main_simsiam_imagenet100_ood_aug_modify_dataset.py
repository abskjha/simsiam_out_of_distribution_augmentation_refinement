...
parser.add_argument('--dataset',default='imagenet100_aug_refine', help='path to dataset: imagenet100')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_loader.dataset.r_model = r_model
    train_loader.dataset.c_model = c_model
    train_loader.dataset.r_c_loss_avg = r_c_loss_avg
    train_loader.gpu = args.gpu
